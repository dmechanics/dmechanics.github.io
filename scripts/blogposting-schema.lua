...
local SITE_URL = "https://example.com"
...
function Meta(meta)
  ...
  json = json .. ',"author":{"@id":"' .. SITE_URL .. '/#person"}'

  json = json .. ',"publisher":{"@type":"Person"'
  json = json .. ',"name":"Damir Mađarević"'
  json = json .. ',"url":"' .. SITE_URL .. '"'
  json = json .. ',"image":{"@type":"ImageObject","url":"' .. SITE_URL .. '/img/portrait.webp"}'
  json = json .. '}'
  ...
  json = json .. ',"inLanguage":"sr"'
  json = json .. ',"isPartOf":{"@id":"' .. SITE_URL .. '/#website"}'
